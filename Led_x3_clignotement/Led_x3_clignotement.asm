...
start:
	ldi		r17, (1<<DDB2)|(1<<DDB1)|(1<<DDB0)	; Chargement du registre r17 avec les pins 0, 1 et 2 définit à 1
    out		DDRB, r17							; Pin 0, 1 et 2 définit comme sorties
	clr		r17									; Registre vidé
